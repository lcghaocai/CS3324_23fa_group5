...
filedir = '.'
save_path = './efficientnet_model.pth'
...
if __name__ == '__main__':
    ...
    raw_data = MySet("/kaggle/input/trainingset/1-Images/1-Training Set",
                    "/kaggle/input/groundtruths/2-Groundtruths/HRDC Hypertensive Classification Training Labels.csv")
